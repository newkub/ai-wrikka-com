<template>
  <div 
    class="bg-block rounded-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden border border flex flex-col h-full group"
  ...
  >
    ...
    >
      ...
      <div 
        v-else
        class="w-full h-full"
        :class="bookmark.gradient ? `bg-gradient-to-r ${bookmark.gradient.from} ${bookmark.gradient.to}` : 'bg-gray-100 dark:bg-gray-800'"
      />
