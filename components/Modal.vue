  ...
  <Teleport to="body">
    ...
    >
      ...
      >
        ...
        >
          <div 
            class="bg-white dark:bg-surface-900 rounded-lg w-full max-w-4xl max-h-[90vh] flex flex-col shadow-xl"
            :class="contentClass"
            @click.stop
            role="dialog"
            aria-modal="true"
          ...
          >
            ...
            <!-- Footer Slot -->
            <div v-if="$slots.footer" class="p-4 border-t border-border bg-surface-50 dark:bg-surface-800/50">
