      ...
      <div class="w-56 border-r border-border pr-4">
        ...
        <div class="relative mb-4">
          ...
          <input
            ...
            class="w-full pl-9 pr-3 py-2 text-sm bg-surface-50 dark:bg-surface-800 border border-border rounded-md focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-transparent"
          />
        </div>
        ...
        <div v-if="!isSearching" class="space-y-1">
          <button
            ...
            :class="{
              'bg-surface-100 dark:bg-surface-700 text-primary-500': activeTab === tab.id,
              'hover:bg-surface-50 dark:hover:bg-surface-700': activeTab !== tab.id
            }"
          >
        ...
        <div v-else class="space-y-2">
          ...
          <div class="space-y-1">
            <button
              ...
              class="w-full flex items-center space-x-2 px-3 py-2 text-sm rounded-md hover:bg-surface-50 dark:hover:bg-surface-700 transition-colors"
            >
          ...
          <div v-if="isSearching">
            ...
            >
              <div class="text-center">
                ...
                <h4 class="mt-2 text-lg font-medium text-text">
                  No results found
                </h4>
              ...
              <div class="space-y-6">
                <div>
                  ...
                  <div class="grid grid-cols-3 gap-3">
                    <button 
                      class="p-4 border border-border rounded-lg text-center hover:border-brand transition-colors"
                    >
