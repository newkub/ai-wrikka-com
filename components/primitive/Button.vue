...
const buttonClasses = computed(() => {
	...
	const variants = {
		primary:
			"bg-color-primary text-white hover:opacity-90 focus:ring-color-primary",
		secondary:
			"bg-gray-200 text-gray-900 hover:bg-gray-300 focus:ring-gray-500 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600",
		outline:
			"border border-gray-300 bg-transparent text-gray-700 hover:bg-gray-50 focus:ring-color-primary dark:border-gray-600 dark:text-white dark:hover:bg-gray-700",
		ghost:
			"bg-transparent text-gray-700 hover:bg-gray-100 focus:ring-color-primary dark:text-white dark:hover:bg-gray-700",
